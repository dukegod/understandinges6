...
ES6，更为广泛的叫做ECMAScript 2015,是ECMAScript最新的版本。是从2009年以后ECMAScript做出的最大的升级，主要的js环境对其支持情况可以查看[支持情况](http://kangax.github.io/es5-compat-table/es6/)

[ES6标准文档](http://www.ecma-international.org/ecma-262/6.0/) 查看完整的ECMAScript语言文档
...
箭头函数使用‘=>’语法。语法上与C#,java8,CofferScript 比较相似，他们支持块元素声明和表达式声明，**与以往的不同，箭头函数‘this’永远指向外部外部**。
...
ES6的类是一个基本原型继承的简单语法糖。更加方便的运用类和继承。

支持基于原型链的继承，super 调用， 实例方法， 静态方法和 构造函数
